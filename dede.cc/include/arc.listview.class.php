...
class ListView
{
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($cfg_rewrite == 'Y')
        {
            ...
            //$purl = $nowurls[0];
			$purl  = substr($purl, 0,strrpos($purl,'/')+1);
        }

        //$geturl = "tid=".$this->TypeID."&TotalResult=".$this->TotalResult."&";
		$geturl_h = "list_".$this->TypeID."_";
       // $purl .= '?'.$geturl;
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<li><a href='".$purl.$geturl_h."$prepagenum.html'>上一页</a></li>\r\n";
            $indexpage="<li><a href='".$purl.$geturl_h."1.html'>首页</a></li>\r\n";
        }
        else
        {
        ...
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<li><a href='".$purl.$geturl_h."$nextpagenum.html'>下一页</a></li>\r\n";
            $endpage="<li><a href='".$purl.$geturl_h."$totalpage.html'>末页</a></li>\r\n";
        }
        else
        {
        ...
        for($j;$j<=$total_list;$j++)
        {
            ...
            {
                $listdd.="<li><a href='".$purl.$geturl_h."$j.html'>".$j."</a></li>\r\n";
            }
        }
