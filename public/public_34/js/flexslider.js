...
;(function (d) {
    d.flexslider = function (i, k) {
            ...
            init: function () {
                ...
                setup: function () {
                    ...
                    a.slides.click(function (b) {
                        ...
                        !d(c.asNavFor).data("gui-flexslider").animating && !b.hasClass("active") && (a.direction = a.currentItem < g ? "next" : "prev", a.flexAnimate(g, c.pauseOnAction, !1, !0, !0))
                    })
                }
            }, controlNav: {
                setup: function () {
                ...
                setup: function () {
                    ...
                    if(op){
                        a.hover(function(){
                            $(this).find('div.'+e+'opacity').show();
                        },function(){
                            $(this).find('div.'+e+'opacity').hide();
                        });
                    }
                    if(n){
                        a.hover(function(){
                ...
                var g = d(c.sync).data("gui-flexslider"), e = a.animatingTo;
                switch (b) {
                    case "animate":
        ...
        a.flexAnimate = function (b, g, n, i, k) {
            ...
            if (!a.animating && (a.canAdvance(b, k) || n) && a.is(":visible")) {
                if (s && i)if (n = d(c.asNavFor).data("gui-flexslider"), a.atEnd = 0 === b || b === a.count - 1, n.flexAnimate(b, !0, !1, !0, k), a.direction = a.currentItem < b ? "next" : "prev", n.direction = a.direction, Math.ceil((b + 1) / a.visible) - 1 !== a.currentSlide && 0 !== b)a.currentItem = b, a.slides.removeClass(e + "active-slide").eq(b).addClass(e +
    ...
    d.fn.flexslider = function (i) {
        ...
        if ("object" === typeof i)return this.each(function () {
            var a = d(this), c = a.find(i.selector ? i.selector : ".gui-slides > li");
